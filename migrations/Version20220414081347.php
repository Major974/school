 ...
 */
final class Version20220414081347 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT NOT NULL, studyplace_id INT DEFAULT NULL, sexe VARCHAR(255) NOT NULL, global_note NUMERIC(4, 2) DEFAULT NULL, note LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', mail_parent VARCHAR(255) NOT NULL, INDEX IDX_B723AF334CFBBE06 (studyplace_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
